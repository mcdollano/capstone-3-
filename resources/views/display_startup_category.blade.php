@extends("home_template")
	@section("display_category_startup")
		...
		<div class="display_articles_container">
			...
			<div class="category_content_container row">
				...
				<div class="col-sm-8 col-md-8 col-lg-8">
					<h2>{{ $startup_category_first->category}}</h2>

					<div class="cat_bannerimage_container">
					
						<a href='{{url("/viewarticle/$startup_category_first->id")}}'>
							<img src="{{ $startup_category_first->banner_image }}">	
						</a>
						...
						<div class="cat_caption_container">
					 		...
					 		<h5>
							 	...
							 	{{ $startup_category_first->category }}
							 	</span>
					 			<p class="caption_bottom2">
							 	{{ $startup_category_first->title }}
							 	</p>
							</h5>
						</div>
					</div>
					...
					@foreach($startup_category_all as $startup_category) 

					<div class="display_cat_articles row">
						<a href='{{url("/viewarticle/$startup_category->id")}}'>
							<div class="latest_article_image_container col-sm-6 col-md-6 col-lg-6 display_cat_left">
								<img src="{{ $startup_category->banner_image }}">	
							</div>
						</a>
							<div class="latest_article_content_container col-sm-6 col-md-6 col-lg-6">
								...
								<a href='{{url("/viewarticle/$startup_category->id")}}'>
									<div class="latest_article_title_container">
										{{$startup_category->title }}
									</div>
								</a>	
									<div class="latest_article_caption_container">
										{!! $startup_category->caption !!}
									</div>
									...
									<div class="latest_article_createdat_container">
										{{ $startup_category->publish_date }}{{ $startup_category->created_at }}
									</div>	
