@extends("home_template")
	@section("display_category_leadership")
		...
		<div class="display_articles_container">
			...
			<div class="category_content_container row">
				...
				<div class="col-sm-8 col-md-8 col-lg-8">
					<h2>{{ $leadership_category_first->category}}</h2>

					<div class="cat_bannerimage_container">
					
						<a href='{{url("/viewarticle/$leadership_category_first->id")}}'>
							<img src="{{ $leadership_category_first->banner_image }}">	
						</a>
						...
						<div class="cat_caption_container">
					 		...
					 		<h5>
							 	...
							 	{{ $leadership_category_first->category }}
							 	</span>
					 			<p class="caption_bottom2">
							 	{{ $leadership_category_first->title }}
							 	</p>
							</h5>
						</div>
					</div>
